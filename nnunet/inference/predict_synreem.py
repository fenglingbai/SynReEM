...
def main():
    ...
    parser.add_argument("-i", '--input_folder', help="Must contain all modalities for each patient in the correct"
                        ...
                        default="/path/to/your/Train/Data//Task603_synapse178synins/imagesTs/")
    parser.add_argument('-o', "--output_folder", help="folder for saving predictions",
                        default="/path/to/your/Inference/Data/")
    parser.add_argument('-t', '--task_name', help='task name or task ID, required.', default="603")
    ...
    # use default other than action
    parser.add_argument('-z', '--save_npz', required=False, default=True,
                        help="use this if you want to ensemble these predictions with those of other models. Softmax "
                             "probabilities will be saved as compressed numpy arrays in output_folder and can be "
                             "merged between output_folders with nnUNet_ensemble_predictions")
